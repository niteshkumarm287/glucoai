# Contributing to glucoai

## Project scope

Early ML project scaffold. The repository currently contains a dataset and project description, not a trained prediction system. Confirm dataset provenance and usage rights before building a model.
